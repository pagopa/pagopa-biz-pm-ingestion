...
@NoArgsConstructor
public class PayPalExtractionSpec implements Specification<PPTransaction> {
	...
	public PayPalExtractionSpec(String dateFrom, String dateTo, List<String> taxCodes) {
