...
import static it.gov.pagopa.bizpmingestion.util.Constants.HEADER_REQUEST_ID;
      ...
      .servers(List.of(new Server().url("http://localhost:8080"),
          new Server().url("https://{host}{basePath}")
              .variables(new ServerVariables()
                ...
                .addServerVariable("basePath", new ServerVariable()._enum(List.of("/pm-ingestion/v1"))
                  ._default("/pm-ingestion/v1"))
              )))
        .components(
            new Components()
                .addSecuritySchemes(
